...
void draw() {
  ...
  // Nagłówki
  {
    ...
    drawMCU(marginLeft, 85, 19, 220, 22, 12, "Doświadczenie zawodowe", 3, 4*(marginRight-marginLeft)); //<>//
    drawMCU(marginLeft, 135, 12, 135, 22, 12, "Wykształcenie", 3, 4*(marginRight-marginLeft));
    drawMCU(marginLeft, 180, 11, 124, 22, 12, "Umiejętności", 3, 4*(marginRight-marginLeft));
    drawMCU(marginLeft, 211, 7, 75, 22, 12, "Hobby", 3, 4*(marginRight-marginLeft));
    drawMCU(marginLeft, 240, 6, 64, 22, 12, "Linki", 3, 4*(marginRight-marginLeft));
  }
